# Техническое задание (исходник)

> Текст извлечён из артефакта-ТЗ, переданного заказчиком:
> https://claude.ai/code/artifact/e2b42702-dc81-4772-881d-de70d04f356e
> Версия ТЗ: 2026-09-14. Расхождения этого текста с реализацией разобраны
